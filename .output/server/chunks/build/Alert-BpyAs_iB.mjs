...
import { t as tv, b as _sfc_main$3, d as _sfc_main$6, a as _sfc_main$1 } from './Button-DY_XlQwR.mjs';
            ...
            return [
              renderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => [
                __props.avatar ? (openBlock(), createBlock(_sfc_main$3, mergeProps({
                  ...
                  "data-slot": "avatar",
                  class: ui.value.avatar({ class: props.ui?.avatar })
                }), null, 16, ["size", "class"])) : __props.icon ? (openBlock(), createBlock(_sfc_main$6, {
                  key: 1,
                  name: __props.icon,
                  "data-slot": "icon",
                  class: ui.value.icon({ class: props.ui?.icon })
...
//# sourceMappingURL=Alert-BpyAs_iB.mjs.map
