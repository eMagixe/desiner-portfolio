import { _ as _sfc_main$7, d as _sfc_main$6, a as _sfc_main$5, t as tv, g as getSlotChildrenText, e as _sfc_main$1$1 } from './Button-DY_XlQwR.mjs';
import { _ as _sfc_main$3 } from './PageHeader-BE9o-I04.mjs';
import { defineComponent, computed, withCtx, unref, createVNode, toDisplayString, createBlock, openBlock, Fragment, renderList, createTextVNode, mergeProps, renderSlot, useSlots, ref, watch, createCommentVNode, useSSRContext } from 'vue';
...
import { _ as _sfc_main$4 } from './Alert-BpyAs_iB.mjs';
                    ...
                    _push3(ssrRenderComponent(_component_UPageCard, {
                      ...
                      body: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          _push4(`<div${_scopeId3}><h2${_scopeId3}>${ssrInterpolate(skill.name)}</h2><p class="mt-1 text-sm md:h-[50px]"${_scopeId3}>${ssrInterpolate(skill.description.join(", "))}</p></div></div>`);
                        } else {
                          return [
                            createVNode("div", { class: "w-full flex flex-row justify-start items-center gap-5" }, [
                              ...
                              createVNode("div", null, [
                                ...
                                createVNode("p", { class: "mt-1 text-sm md:h-[50px]" }, toDisplayString(skill.description.join(", ")), 1)
                              ])
                            ])
                          ];
                        }
...
//# sourceMappingURL=skills-3RYJcyrK.mjs.map
