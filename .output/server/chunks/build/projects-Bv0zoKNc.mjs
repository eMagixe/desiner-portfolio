import { _ as _sfc_main$7, c as __nuxt_component_3, a as _sfc_main$3, t as tv } from './Button-DY_XlQwR.mjs';
import { _ as _sfc_main$2 } from './PageHeader-BE9o-I04.mjs';
import { defineComponent, withCtx, createVNode, createTextVNode, toDisplayString, computed, ref, watch, unref, mergeProps, createBlock, createCommentVNode, openBlock, Fragment, renderList, renderSlot, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrInterpolate, ssrRenderClass, ssrRenderList, ssrRenderAttrs, ssrRenderSlot, ssrRenderAttr } from 'vue/server-renderer';
import useEmblaCarousel from 'embla-carousel-vue';
import { useForwardProps, Primitive } from 'reka-ui';
import { reactivePick } from '@vueuse/core';
import { u as useLocale } from './useLocale-X2D1_gbG.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const images = [];
    for (let i = 1; i < 50; i++) {
      images.push(`/images/projects/${i}.jpg`);
    }
    useSeoMeta({
...
//# sourceMappingURL=projects-Bv0zoKNc.mjs.map
