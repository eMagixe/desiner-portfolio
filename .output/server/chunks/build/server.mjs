...
const _routes = [
  {
    name: "jobs___ru",
    path: "/jobs",
    component: () => import('./jobs-CHfx5xSs.mjs')
  },
  {
    name: "about___ru",
    path: "/about",
    component: () => import('./about-D_KZVUAf.mjs')
  },
  {
    name: "index___ru",
    path: "/",
    component: () => import('./index-P4mo_sza.mjs')
  },
  {
    name: "skills___ru",
    path: "/skills",
    component: () => import('./skills-3RYJcyrK.mjs')
  },
  {
    name: "projects___ru",
    path: "/projects",
    component: () => import('./projects-Bv0zoKNc.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-CQszFpTc.mjs').then((r) => r["default"] || r.default || r));
  ...
  ru: [
    {
      ...
      load: () => import(
        './ru-V8UeyJ1A.mjs'
        /* webpackChunkName: "locale_ru_46json_e800195c" */
      ),
      cache: true
    }
  ]
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/CG3OYC4n"}/${locale}/messages.json`, { headers });
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/CG3OYC4n"}/${locale}/messages.json`));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-4NJeSe7C.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CHOER8Pj.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DBLYIlr9.mjs'));
