import { defineComponent, ref, mergeProps, withCtx, unref, createVNode, toDisplayString, useSlots, computed, renderSlot, createBlock, createCommentVNode, openBlock, createTextVNode, Fragment, renderList, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrInterpolate, ssrRenderSlot, ssrRenderClass, ssrRenderList } from 'vue/server-renderer';
import { Primitive, Slot } from 'reka-ui';
import { c as __nuxt_component_3, d as _sfc_main$6$1, t as tv, _ as _sfc_main$7, a as _sfc_main$8, g as getSlotChildrenText, e as _sfc_main$1$1 } from './Button-DY_XlQwR.mjs';
import { b as useI18n, c as useSeoMeta, n as navigateTo, a as useAppConfig } from './server.mjs';
import { _ as _sfc_main$6 } from './Tooltip-D7UgMFOB.mjs';
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$4), ...appConfig.ui?.page || {} })({
      left: !!slots.left,
      right: !!slots.right
    }));
            ...
            return [
              __props.icon || !!slots.leading ? (openBlock(), createBlock("div", {
                ...
                renderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => [
                  __props.icon ? (openBlock(), createBlock(_sfc_main$6$1, {
                    key: 0,
                    name: __props.icon,
                    "data-slot": "leadingIcon",
                    class: ui.value.leadingIcon({ class: props.ui?.leadingIcon })
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UMarquee = _sfc_main$1;
      const _component_UTooltip = _sfc_main$6;
      const _component_UIcon = _sfc_main$6$1;
      _push(ssrRenderComponent(_component_UPage, mergeProps({ class: "background-index" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                ...
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_UMarquee, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_UTooltip, { text: "Archicad" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_UIcon, {
                                name: "i-simple-icons-archicad",
                        ...
                        _push4(ssrRenderComponent(_component_UTooltip, { text: "Blender 3D" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_UIcon, {
                                name: "i-simple-icons-blender",
                                class: "size-10 shrink-0"
                              }, null, _parent5, _scopeId4));
                            } else {
                              return [
                        ...
                        _push4(ssrRenderComponent(_component_UTooltip, { text: "Autodesk 3Ds Max" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_UIcon, {
                                name: "i-simple-icons-autodesk",
                                class: "size-10 shrink-0"
                              }, null, _parent5, _scopeId4));
                            } else {
                              return [
                        ...
                        _push4(ssrRenderComponent(_component_UTooltip, { text: "web3.js" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_UIcon, {
                                name: "i-simple-icons-web3dotjs",
                                class: "size-10 shrink-0"
                              }, null, _parent5, _scopeId4));
                            } else {
                              return [
                        ...
                        _push4(ssrRenderComponent(_component_UTooltip, { text: "Github" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_UIcon, {
                        ...
                        return [
                          createVNode(_component_UTooltip, { text: "Archicad" }, {
                            default: withCtx(() => [
                              createVNode(_component_UIcon, {
                                name: "i-simple-icons-archicad",
                                class: "size-10 shrink-0"
                          ...
                          createVNode(_component_UTooltip, { text: "Blender 3D" }, {
                            default: withCtx(() => [
                              createVNode(_component_UIcon, {
                                name: "i-simple-icons-blender",
                                class: "size-10 shrink-0"
                          ...
                          createVNode(_component_UTooltip, { text: "Autodesk 3Ds Max" }, {
                            default: withCtx(() => [
                              createVNode(_component_UIcon, {
                                name: "i-simple-icons-autodesk",
                                class: "size-10 shrink-0"
                          ...
                          createVNode(_component_UTooltip, { text: "web3.js" }, {
                            default: withCtx(() => [
                              createVNode(_component_UIcon, {
                                name: "i-simple-icons-web3dotjs",
                                class: "size-10 shrink-0"
...
//# sourceMappingURL=index-P4mo_sza.mjs.map
