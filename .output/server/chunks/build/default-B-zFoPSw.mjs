...
import { l as localeContextInjectionKey, u as useLocale } from './useLocale-X2D1_gbG.mjs';
import { t as tv, g as getSlotChildrenText, a as _sfc_main$j, e as _sfc_main$1$1, _ as _sfc_main$7$1, i as isArrayOfArray, b as _sfc_main$3$1, d as _sfc_main$6$1, f as get, p as pickLinkProps, h as _sfc_main$2$1, u as useFieldGroup, j as useComponentIcons, o as omit } from './Button-DY_XlQwR.mjs';
import { p as portalTargetInjectionKey, _ as _sfc_main$k, u as usePortal } from './Tooltip-D7UgMFOB.mjs';
import { _ as _export_sfc, f as __nuxt_component_3$1, a as useAppConfig, d as useRoute, e as useState } from './server.mjs';
...
import { _ as __nuxt_component_0$1 } from './nuxt-link-CnkUJj0f.mjs';
...
const _sfc_main$i = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$b), ...appConfig.ui?.slideover || {} })({
                                    ...
                                    if (_push5) {
                                      ...
                                      return [
                                        renderSlot(_ctx.$slots, "close", { ui: ui.value }, () => [
                                          props.close ? (openBlock(), createBlock(_sfc_main$j, mergeProps({
                                            key: 0,
                                            icon: __props.closeIcon || unref(appConfig).ui.icons.close,
                                            color: "neutral",
                                            variant: "ghost",
...
const _sfc_main$h = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$a), ...appConfig.ui?.modal || {} })({
      transition: props.transition,
...
const _sfc_main$g = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$9), ...appConfig.ui?.drawer || {} })({
...
const _sfc_main$f = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$8), ...appConfig.ui?.header || {} })());
    const Menu = computed(() => ({
          ...
          if (_push2) {
            ...
            return [
              renderSlot(_ctx.$slots, "toggle", {
                ...
                __props.toggle ? (openBlock(), createBlock(_sfc_main$j, mergeProps({
                  key: 0,
                  color: "neutral",
                  variant: "ghost",
                  "aria-label": open.value ? unref(t)("header.close") : unref(t)("header.open"),
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="${ssrRenderClass([`text-${props.size} border-[${color}] bg-[#9D74FC]`, "text-gray-100! border-2 border-r-0 px-1"])}"${_scopeId}>3D</span><span class="${ssrRenderClass([`text-${props.size} border-[${color}]`, "border-2 px-1 text-gray-100!"])}"${_scopeId}> Modeler </span>`);
          } else {
            return [
              createVNode("span", {
                class: ["text-gray-100! border-2 border-r-0 px-1", `text-${props.size} border-[${color}] bg-[#9D74FC]`]
              }, "3D", 2),
              createVNode("span", {
                class: ["border-2 px-1 text-gray-100!", `text-${props.size} border-[${color}]`]
              }, " Modeler ", 2)
            ];
          }
        }),
...
const __nuxt_component_2$1 = Object.assign(_sfc_main$e, { __name: "ActionsLogo" });
const theme$7 = {
  "slots": {
...
const _sfc_main$d = {
  ...
  setup(__props) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$7), ...appConfig.ui?.badge || {} })({
      color: props.color,
...
const _sfc_main$b = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$5), ...appConfig.ui?.navigationMenu || {} })({
      orientation: props.orientation,
                            ...
                            default: withCtx((_2, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                if (__props.orientation === "vertical" && __props.collapsed && item.children?.length && (!!props.popover || !!item.popover)) {
                                  ...
                                  _push5(ssrRenderComponent(_sfc_main$k, mergeProps({
                                ...
                                return [
                                  __props.orientation === "vertical" && __props.collapsed && item.children?.length && (!!props.popover || !!item.popover) ? (openBlock(), createBlock(_sfc_main$c, mergeProps({ key: 0 }, { ...popoverProps.value, ...typeof item.popover === "boolean" ? {} : item.popover || {} }, {
                                    ...
                                    _: 2
                                  }, 1040, ["ui"])) : __props.orientation === "vertical" && __props.collapsed && (!!props.tooltip || !!item.tooltip) ? (openBlock(), createBlock(_sfc_main$k, mergeProps({
                                    key: 1,
                                    text: unref(get)(item, props.labelKey)
                                  }, { ...tooltipProps.value, ...typeof item.tooltip === "boolean" ? {} : item.tooltip || {} }), {
                                    default: withCtx(() => [
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  const _component_UButton = _sfc_main$j;
  _push(`<!--[-->`);
  _push(ssrRenderComponent(_component_UButton, {
    icon: "i-simple-icons-telegram",
    color: "neutral",
    variant: "ghost",
    to: "https://t.me/tanechka_ar",
    target: "_blank",
    "aria-label": "Telegram"
  }, null, _parent));
  _push(ssrRenderComponent(_component_UButton, {
...
const __nuxt_component_3 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$a, [["ssrRender", _sfc_ssrRender$1]]), { __name: "ActionsContacts" });
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  __name: "top",
  __ssrInlineRender: true,
  setup(__props) {
    const main = computed(() => {
      return useAppConfig().ru.sidebar.links;
    });
    return (_ctx, _push, _parent, _attrs) => {
                ...
                _push2(ssrRenderComponent(unref(ToastClose), { "as-child": "" }, {
                  default: withCtx((_, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      return [
                        renderSlot(_ctx.$slots, "close", { ui: ui.value }, () => [
                          __props.close ? (openBlock(), createBlock(_sfc_main$j, mergeProps({
                            key: 0,
                            icon: __props.closeIcon || unref(appConfig).ui.icons.close,
                            color: "neutral",
                            variant: "link",
        ...
        _push(ssrRenderComponent(_component_UFooter, mergeProps({ class: "border border-t-gray-200 border-b-0 border-x-0" }, _attrs), {
          left: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              return [
                createVNode("p", { class: "text-muted text-sm" }, "Архипова Татьяна © " + toDisplayString((/* @__PURE__ */ new Date()).getFullYear()), 1)
              ];
            }
          }),
          right: withCtx((_, _push2, _parent2, _scopeId) => {
